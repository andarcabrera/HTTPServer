...
public class AccessDirectoryTest {
    ...
    public void testUsingTempFolder() throws IOException {
        ...
        assertTrue(accessDirectory.getFiles(folderPath)[1].getPath().contains("testFile2"));
        assertTrue(accessDirectory.getFiles(folderPath)[2].getPath().contains("testFile3"));
    }
}
